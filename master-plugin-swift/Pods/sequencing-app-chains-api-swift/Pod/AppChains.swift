...
public class AppChains {
    ...
    */
    public init(token: String, chainsHostname: String) {
        self.token = token
    ...
    * @return
    */
    public func getReport(remoteMethodName: String, applicationMethodName: String, datasourceId: String) -> ReturnValue<Report> {
    ...
    * @return
    */
    public func getReport(remoteMethodName:String, requestBody:String) -> ReturnValue<Report> {
    ...
    * @return
    */
    public func getSequencingBeacon(chrom: Int, pos: Int, allele: String) -> ReturnValue<String> {
    ...
    * @return
    */
    public func getPublicBeacon(chrom: Int, pos: Int, allele: String) -> ReturnValue<String> {
    ...
    */
    func httpRequest(method: String, url: NSURL, body: String) -> ReturnValue<HttpResponse> {
        ...
        do {
            ...
            if rawResponse != nil {
                response = rawResponse as! NSHTTPURLResponse
            } else {
    ...
    */
    func urlEncode(v: String) -> String {
        let encodedMessage = v.stringByAddingPercentEncodingWithAllowedCharacters(NSCharacterSet.URLHostAllowedCharacterSet())
...
public class Report {
    ...
    public var results: Array<Result> = [Result]()
}
